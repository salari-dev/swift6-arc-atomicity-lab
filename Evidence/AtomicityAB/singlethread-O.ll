; ModuleID = '/Users/msalari/Downloads/swift6-arc-refcount-lab/Evidence/AtomicityAB/singlethread-O.ll'
source_filename = "/Users/msalari/Downloads/swift6-arc-refcount-lab/Evidence/AtomicityAB/singlethread-O.ll"
...
entryresume.1:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload10) #15
...
entryresume.0:
  ...
  tail call void @swift_nonatomic_bridgeObjectRelease(ptr %7) #15
  ...
  tail call void @swift_nonatomic_bridgeObjectRelease(ptr %10) #15
  ...
  %22 = tail call ptr @swift_nonatomic_retain(ptr returned %13) #31
...
entryresume.1:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload58) #15
...
entryresume.2:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload52) #15
  ...
  tail call void @swift_nonatomic_bridgeObjectRelease(ptr %6) #15
  tail call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %2)
...
entryresume.3:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload64) #15
...
entryresume.4:
  ...
  tail call void @swift_nonatomic_bridgeObjectRelease(ptr %5) #15
  tail call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %1)
  ...
  %11 = tail call ptr @swift_nonatomic_retain(ptr returned %6) #31
...
entryresume.5:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload73) #15
...
entryresume.6:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload70) #15
  ...
  tail call void @swift_nonatomic_release(ptr %.reload44) #15
...
; Function Attrs: nounwind
declare void @swift_nonatomic_bridgeObjectRelease(ptr) local_unnamed_addr #15
...
entry:
  %1 = getelementptr inbounds nuw i8, ptr %0, i64 112
  %2 = load ptr, ptr %1, align 16
  tail call void @swift_nonatomic_release(ptr %2) #15
...
entryresume.0:
  ...
  %8 = tail call ptr @swift_nonatomic_retain(ptr returned %.reload) #31
...
entryresume.1:
  ...
  tail call void @swift_nonatomic_release(ptr %.reload17) #15
...
; Function Attrs: nounwind
declare void @swift_nonatomic_unknownObjectRelease(ptr) local_unnamed_addr #15

; Function Attrs: nounwind
declare void @swift_nonatomic_release(ptr) local_unnamed_addr #15
...
entry:
  ...
  %15 = call ptr @swift_nonatomic_retain(ptr returned %4) #31
...
23:                                               ; preds = %16, %21
  ...
  %30 = call ptr @swift_nonatomic_unknownObjectRetain(ptr returned %29) #15
  call void @swift_nonatomic_release(ptr %4) #15
  %31 = icmp eq i64 %26, 0
...
32:                                               ; preds = %23
  ...
  call void @swift_nonatomic_unknownObjectRelease(ptr nonnull %29) #15
...
41:                                               ; preds = %37
  ...
  %47 = or i64 %39, %38
  %48 = icmp eq i64 %47, 0
  %49 = call ptr @swift_nonatomic_retain(ptr nonnull returned %4) #31
...
initial_serial_executor.cont6:                    ; preds = %initial_serial_executor.some5, %41
  ...
  call void @swift_nonatomic_release(ptr nonnull %4) #15
  call void @swift_nonatomic_release(ptr %43) #15
  br label %65
...
declare ptr @swift_nonatomic_retain(ptr returned) local_unnamed_addr #22
...
entryresume.1:
  ...
  %3 = getelementptr inbounds nuw i8, ptr %2, i64 16
  %4 = load i64, ptr %3, align 8
  tail call void @swift_nonatomic_release(ptr %.reload) #15
...
41:                                               ; preds = %37
  %42 = inttoptr i64 %1 to ptr
  %43 = call swiftcc ptr @"$sSS11utf8CStrings15ContiguousArrayVys4Int8VGvg"(i64 %0, ptr nonnull %42)
  call void @swift_nonatomic_bridgeObjectRelease(ptr nonnull %42) #15
  %44 = getelementptr inbounds nuw i8, ptr %43, i64 32
...
entry:
  ...
  tail call void @swift_nonatomic_unknownObjectRelease(ptr %2) #15
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %toDestroy = load ptr, ptr %3, align 8
  tail call void @swift_nonatomic_release(ptr %toDestroy) #15
...
; Function Attrs: nounwind
declare ptr @swift_nonatomic_unknownObjectRetain(ptr returned) local_unnamed_addr #15
...
entry:
  ...
  tail call void @swift_nonatomic_release(ptr %1) #15
