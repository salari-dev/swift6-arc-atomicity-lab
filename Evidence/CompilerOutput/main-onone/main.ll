; ModuleID = '/Users/msalari/Downloads/swift6-arc-refcount-lab/Evidence/CompilerOutput/main-onone/main.ll'
source_filename = "/Users/msalari/Downloads/swift6-arc-refcount-lab/Evidence/CompilerOutput/main-onone/main.ll"
...
entryresume.1:
  ...
  call void @swift_unknownObjectRelease(ptr %3) #4
...
entryresume.0:
  ...
  call void @swift_bridgeObjectRelease(ptr %16) #4
  ...
  call void @swift_bridgeObjectRelease(ptr %20) #4
...
entryresume.1:
  ...
  call void @swift_release(ptr %.reload22) #4
...
entryresume.2:
  ...
  call void @swift_bridgeObjectRelease(ptr %9) #4
...
entryresume.5:
  ...
  call void @swift_release(ptr %.reload37) #4
  %11 = load ptr, ptr %4, align 8
...
entryresume.6:
  ...
  call void @swift_bridgeObjectRelease(ptr %12) #4
  ...
  %15 = call ptr @swift_bridgeObjectRetain(ptr returned %14) #4
  ...
  call void @swift_bridgeObjectRelease(ptr %29) #4
  call void @swift_bridgeObjectRelease(ptr %26) #4
  call void @swift_bridgeObjectRelease(ptr %23) #4
...
; Function Attrs: nounwind
declare void @swift_bridgeObjectRelease(ptr) #4
...
entry:
  ...
  %3 = call ptr @swift_retain(ptr returned %2) #13
  ret ptr %2
}
...
entry:
  ...
  call void @swift_release(ptr %2) #4
  ret i64 %5
}
...
entryresume.0:
  ...
  %7 = call ptr @swift_retain(ptr returned %.reload) #13
...
entryresume.1:
  ...
  call void @swift_release(ptr %.reload13) #4
...
; Function Attrs: nounwind
declare void @swift_release(ptr) #4
...
entry:
  ...
  %11 = call ptr @swift_retain(ptr returned %4) #13
...
26:                                               ; preds = %22, %20
  ...
  %36 = call ptr @swift_unknownObjectRetain(ptr returned %34) #4
  %37 = ptrtoint ptr %34 to i64
  %38 = ptrtoint ptr %35 to i64
  call void @swift_release(ptr %4) #4
  %39 = icmp eq i64 %31, 0
...
44:                                               ; preds = %40
  ...
  call void @swift_unknownObjectRelease(ptr %45) #4
  br label %50
...
69:                                               ; preds = %57
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %6)
  call void @swift_release(ptr %60) #4
...
77:                                               ; preds = %72
  ...
  call void @swift_release(ptr %78) #4
  ...
  %81 = call ptr @swift_retain(ptr returned %80) #13
...
106:                                              ; preds = %104, %initial_serial_executor.cont
  ...
  call void @swift_release(ptr %109) #4
...
entryresume.1:
  ...
  call void @swift_release(ptr %.reload) #4
  %3 = load ptr, ptr %1, align 8
...
entry:
  ...
  call void @swift_bridgeObjectRelease(ptr %toDestroy) #4
  ret ptr %0
}
...
57:                                               ; preds = %54
  ...
  %59 = phi ptr [ %55, %54 ]
  %60 = call swiftcc ptr @"$sSS11utf8CStrings15ContiguousArrayVys4Int8VGvg"(i64 %58, ptr %59)
  call void @swift_bridgeObjectRelease(ptr %59) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %6)
  %61 = getelementptr inbounds i8, ptr %60, i64 32
  %62 = ptrtoint ptr %61 to i64
  %63 = getelementptr inbounds nuw %Ts28__ContiguousArrayStorageBaseC, ptr %60, i32 0, i32 1
...
77:                                               ; preds = %72
  ...
  %82 = call ptr @swift_retain(ptr returned %81) #13
...
108:                                              ; preds = %105, %initial_serial_executor.cont
  ...
  call void @swift_release(ptr %110) #4
  call void @llvm.lifetime.end.p0(i64 16, ptr %5)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %10)
  ret ptr %109
}
...
declare ptr @swift_retain(ptr returned) #13
...
; Function Attrs: nounwind
declare void @swift_unknownObjectRelease(ptr) #4
...
; Function Attrs: nounwind
declare ptr @swift_unknownObjectRetain(ptr returned) #4
...
14:                                               ; preds = %11
  ...
  %19 = call ptr @swift_retain(ptr returned %18) #13
